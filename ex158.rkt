...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex158) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define SHOT-CENTER (/ (image-height SHOT) 2))
...
(check-expect (tock (cons 15 (cons -20 sw3)))
              (cons 14 (cons 24 (cons 8 '()))))


; Shot -> Boolean
; is the shot outside the canvas
(define (shot-outside? s)
  (<= s (- SHOT-CENTER)))
