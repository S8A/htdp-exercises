...
; A: It's not a proper use of the function because it makes no sense to take
; chunks of size 0. It doesn't produce anything (it keeps running indefinitely)
; because it can take infinitely many zero-length chunks from any list.
