...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex383) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp")) #f)))
...
; XMachine -> FSM-State 
; extracts the initial state from xm
(define (xm-state0 xm)
  (find-attr 'initial (xexpr-attr xm)))
