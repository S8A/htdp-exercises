...
; XEnum.v2 -> N
; counts all "hello"s in the given enumeration
(define (count-hello enum)
  (foldr + 0 (map count-hello-item (xexpr-content enum))))

(check-expect (count-hello en0) 0)
(check-expect (count-hello en1) 1)

; XItem.v2 -> N
; counts all "hello"s in the given item
...
(check-expect (count-hello-item `(li ,w2)) 0)
(check-expect (count-hello-item `(li ,w1)) 1)
(check-expect (count-hello-item `(li (ul (li ,w1) (li ,en0) (li ,w1)))) 2)
