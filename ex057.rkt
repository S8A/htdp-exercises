...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex057) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (show-rocket HEIGHT)
              (place-image ROCKET 10 (- CENTER) BACKG))
(define (show-rocket y)
  (place-image ROCKET
               10 (- HEIGHT
                     (+ (if (and (number? y) (<= 0 y HEIGHT)) y 0) CENTER))
               BACKG))
...
(check-expect (stop? (+ HEIGHT 1)) #true)
(define (stop? y) (and (number? y) (> y HEIGHT)))
