...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname ex474) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
; A Node is a Symbol.
