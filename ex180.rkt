...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname ex180) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (editor-render e)
  (place-image/align (beside (editor-text (editor-pre e))
                             CURSOR
  ...
  (cond
    ...
    [(cons? s)
     (beside (text (first s) FONT-SIZE FONT-COLOR)
             (editor-text (rest s)))]))
;  (text (implode s) FONT-SIZE FONT-COLOR))  ; Duh
